...
var apiUrl = 'https://mybestevernottakencompany.cloud.tyk.io/techcrunch/';
...
var getData = function getData() {
  fetch(apiUrl).then(function (res) {
    ...
    var arr = articles.map(function (article) {
      return createItem(article);
    }).join('');
...
var createItem = function createItem(item) {
  var date = getArticleDate(item.publishedAt);

  return '<article>\n      <section class="article-header">\n        <img src="' + item.urlToImage + '" />\n        <h2>' + item.title + '</h2>\n      </section>\n      <section class="article-body">\n        <h3>' + item.description + '</h3>\n      </section>\n      <section class="article-footer">\n        <a href="' + item.url + '" target="_blank">Read more...</a>\n        <span>' + item.author + ' | ' + date + '</span>\n      </section>\n     </article>';
};

var getArticleDate = function getArticleDate(dateISOString) {
...
},{"babel-polyfill":1,"whatwg-fetch":298}]},{},[299]);
